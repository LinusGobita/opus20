...
def getValue():
    ...
    parser_logging_action_clear  = subsubparsers.add_parser('clear', help='Clear the tools history on the device')
    ...
    try:
        ...
        if args.cmd == 'logging':
            ...
            if args.action == 'status':
                ...
                o20.clear_log()
                print('Clearing the tools now. This will take a couple of minutes.')
